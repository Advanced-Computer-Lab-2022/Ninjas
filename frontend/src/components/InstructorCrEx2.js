...
const mdTheme = createTheme();
 ...
 const handleClose4 = async () => {
  ...
  const handleClickOpen = async ()=>{ //Add subtitle
    const response = await axios.put(`http://localhost:8000/addAnotherQuestion?subtitleId=${subtitleId}&courseId=${courseId}&exerciseId=${exerciseId}`,{
 ...
 // const[exerciseId, setExId]=useState('');
  ...
  const exerciseId = params3.get('exerciseId');
